...
void send_char(char c) {
	...
	if (c == 0x0) temp = 0x30; 	
	else if (c == 0x1) temp = 0x31;
	else if (c == 0x2) temp = 0x32;
	else if (c == 0x3) temp = 0x33;
	else if (c == 0x4) temp = 0x34;
	else if (c == 0x5) temp = 0x35;
	else if (c == 0x6) temp = 0x36;
	else if (c == 0x7) temp = 0x37;
	else if (c == 0x8) temp = 0x38;
	else if (c == 0x9) temp = 0x39;
	else if (c == 0xa) temp = 0x41;
	else if (c == 0xb) temp = 0x42;
	else if (c == 0xc) temp = 0x43;
	else if (c == 0xd) temp = 0x44;
	else if (c == 0xe) temp = 0x45;
	else if (c == 0xf) temp = 0x46;
